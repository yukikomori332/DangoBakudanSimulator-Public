...
namespace Project.Core.Scripts.View.Archive
{
    ...
    /// 図鑑画面のボタンの状態を管理するクラス
    /// </summary>
    public sealed class ArchiveButtonViewState : AppViewState, IArchiveButtonState
    {
        ...
        /// ボタンがクリックされた時の処理
        /// </summary>
        void IArchiveButtonState.InvokeClicked()
        {
    ...
    /// </summary>
    internal interface IArchiveButtonState
    {
        /// <summary>
        /// ボタンのクリックイベントを発火させる
        /// </summary>
