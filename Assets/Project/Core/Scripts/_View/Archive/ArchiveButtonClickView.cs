...
namespace Project.Core.Scripts.View.Archive
{
    ...
    /// </summary>
    [RequireComponent(typeof(ArchiveButtonView))]
    public sealed class ArchiveButtonClickView : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        [Header("Components")]
        [SerializeField] private RectTransform customRect;
