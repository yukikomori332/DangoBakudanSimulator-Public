...
{
    /// <summary>
    /// ゲームプレイ画面のボタンのビューコンポーネント
    /// ホバー状態に応じて表示を切り替える機能を提供
    /// </summary>
    [RequireComponent(typeof(GameplayButtonView))]
    public sealed class GameplayButtonHoverView : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [Header("Components")]
