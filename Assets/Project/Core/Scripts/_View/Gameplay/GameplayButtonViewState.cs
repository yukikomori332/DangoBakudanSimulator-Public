...
{
    /// <summary>
    /// ゲームプレイ中のボタンの状態を管理するViewStateクラス
    /// </summary>
    public sealed class GameplayButtonViewState : AppViewState, IGameplayButtonState
    {
        ...
        /// ボタンがクリックされた時の処理
        /// </summary>
        void IGameplayButtonState.InvokeClicked()
        {
    ...
    /// </summary>
    internal interface IGameplayButtonState
    {
        /// <summary>
        /// ボタンのクリックイベントを発火させる
        /// </summary>
